...
?>
<?php 
    // $data = array("id"=>"frm_import","enctype"=>"multipart/form-data");
    // echo form_open((base_url().'/Productos/importExcelProductos'),$data);
?>
<!-- /MercadoPago1/mercadoP -->
<form action="<?php echo base_url().'/Productos/imortarDatosExcel'?>"  method="post" enctype="multipart/form-data">
  <input type="file" id="myFile" name="file_excel">
  <input type="submit">
</form>
<?php
// echo form_close();
